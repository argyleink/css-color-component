...
```html
<color-input value="oklch(70% 20% 240 / 80%)" no-alpha></color-input>
```

<Tabs>
  <TabItem label="With Alpha Control">
    <ColorInputDemo value="oklch(70% 20% 240 / 80%)" />
  </TabItem>
  <TabItem label="Without Alpha Control">
    <ColorInputDemo value="oklch(70% 20% 240 / 80%)" no-alpha={true} />
  </TabItem>
</Tabs>
