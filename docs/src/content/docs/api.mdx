...
::::note
The Eye Dropper uses the native [EyeDropper API](https://developer.mozilla.org/en-US/docs/Web/API/EyeDropper_API) and is supported in Chrome and Edge 95+. The button automatically hides itself in browsers that don't support the API (Firefox, Safari).
::::
