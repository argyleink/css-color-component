...
<ColorInputDemo value="oklab(70% 0.1 -0.15)" />
...
<Tabs>
  ...
  <TabItem label="RGB">
    <ColorInputDemo value="rgb(59 130 246)" />
    ```html
    <color-input value="rgb(59 130 246)"></color-input>
    ```
  </TabItem>
</Tabs>
...
<ColorInputDemo value="hwb(240 20% 10%)" />
...
<Tabs>
  <TabItem label="LAB">
    <ColorInputDemo value="lab(70% 20 -40)" />
  </TabItem>
  <TabItem label="LCH">
    <ColorInputDemo value="lch(70% 45 240)" />
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem label="sRGB Linear">
    <ColorInputDemo value="color(srgb-linear 0.25 0.4 0.7)" />
    ```css color(srgb-linear 0.25 0.4 0.7) ```
  </TabItem>
  <TabItem label="a98-rgb">
    <ColorInputDemo value="color(a98-rgb 0.25 0.6 0.85)" />
    ```css color(a98-rgb 0.25 0.6 0.85) ```
  </TabItem>
  <TabItem label="ProPhoto">
    <ColorInputDemo value="color(prophoto 0.35 0.28 0.65)" />
    ```css color(prophoto 0.35 0.28 0.65) ```
  </TabItem>
  <TabItem label="XYZ">
    <ColorInputDemo value="color(xyz 0.25 0.32 0.4)" />
    ```css color(xyz 0.25 0.32 0.4) ```
  </TabItem>
  <TabItem label="XYZ D50">
    <ColorInputDemo value="color(xyz-d50 0.24 0.35 0.38)" />
    ```css color(xyz-d50 0.24 0.35 0.38) ```
  </TabItem>
  <TabItem label="XYZ D65">
    <ColorInputDemo value="color(xyz-d65 0.22 0.33 0.36)" />
    ```css color(xyz-d65 0.22 0.33 0.36) ```
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem label="OKLCH (Best)">
    <ColorInputDemo value="oklch(70% 20% 240)" showCode={false} />
    Perceptually uniform, intuitive
  </TabItem>
  <TabItem label="OKLAB">
    <ColorInputDemo value="oklab(70% 0.1 -0.15)" showCode={false} />
    Perceptually uniform, rectangular
  </TabItem>
  <TabItem label="HSL">
    <ColorInputDemo value="hsl(240 80% 60%)" showCode={false} />
    Familiar but not uniform
  </TabItem>
  <TabItem label="sRGB">
    <ColorInputDemo value="rgb(59 130 246)" showCode={false} />
    Standard web RGB
  </TabItem>
  <TabItem label="Display P3">
    <ColorInputDemo value="color(display-p3 0.3 0.7 0.95)" showCode={false} />
    Wide-gamut RGB
  </TabItem>
</Tabs>
