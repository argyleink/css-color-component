...
<ColorInputDemo value="oklch(70% 20% 240)" colorspace="oklch" description="Try keyboard navigation: Tab to focus, Enter to open, Arrow keys to adjust sliders, Escape to close." />
...
<color-input id="bg-color" value="oklch(70% 20% 240)"></color-input>
```
:::
