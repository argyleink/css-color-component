...
### Example 4: Circle Swatch (Classic)
...
:::tip[Perfect for Color Palettes]
The circle swatch style is ideal for displaying color palettes, design system tokens, or any UI where you need compact, visual color selection.
:::
